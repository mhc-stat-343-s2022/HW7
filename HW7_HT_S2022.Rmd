...
### (b) Carry out a test of the following hypotheses at the level of significance $\alpha=0.05$ by using the two-sided t-test (this is what we derived Monday if you are not familiar):
...
<!-- Let $X_1,...,X_n$ be a random sample from a normal distribution with unknown mean $\mu$ and known variance $\sigma^2$. Consider testing the following hypotheses: -->

<!-- - $H_0: \mu=\mu_0$ -->
<!-- - $H_A: \mu\neq \mu_0$ -->


<!-- ### (a) Find the form of the likelihood ratio test statistic for this test.  -->

<!-- \vspace{5cm} -->

<!-- ### (b) Show that the likelihood ratio test statistic can be simplified to a form that involves the sample mean, $\bar{X}$. -->

<!-- \vspace{5cm} -->

<!-- ### (c) Show that the rejection region for this test corresponds to $R=\left\{(x_1,...,x_n): \right\}$ -->



<!-- ### (d) It can be shown that the $(1-\alpha)*100\%$ confidence interval for $\mu$ is  -->

<!-- $$\left[\bar{X}-z_{\alpha/2}\left(\frac{\sigma}{\sqrt{n}}\right), \bar{X}+z_{\alpha/2}\left(\frac{\sigma}{\sqrt{n}}\right) \right]$$ -->

<!-- Suppose that $\mu_0$ lies in the confidence interval above.  -->